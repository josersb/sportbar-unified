...
Reconciliación unificada server-side (State Broker): auto-adopt (Arranger gana) solo con lectura confirmada, single-flight en server, SyncPanel como indicador de estado, y edge-case handling (offline, timeouts parciales).
...
### Requirement: Double-Call Prevention (REMOVED)
