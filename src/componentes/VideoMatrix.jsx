    ...
    >
      ...
      <div className={styles.grid}>
        ...
        <div className={styles.vwRow} role="list" aria-label="TVs panoramic">
          {VW_IDS.map((id) => (
            <span key={id} id={id} className={styles.tvItem} role="listitem">
              {id}
            </span>
          ))}
        </div>
        ...
        <div className={styles.escaleraBarra}>
          ...
          {/* Barra central */}
          <div>
            <div className={styles.escalera} role="list" aria-label="Escalera centro">
            ...
            <div
              className={styles.barraGrid}
              role="list"
              aria-label="Barra de TVs"
            >
              {BARRA.map((id) => (
                <span
                  key={id}
                  ...
                  role="listitem"
                  style={{ gridArea: GRID_MAP[id] }}
                >
                  {id.replace("TV", "TV").replace("TVRACK", "TVRK")}
                </span>
              ))}
            </div>
          </div>
          ...
          <div className={styles.escalera} role="list" aria-label="Escalera norte">
            {ESCALERA_NORTE.map((id) => (
              <span id={id} className={styles.tvItem} role="listitem">
                {id}
              </span>
            ))}
          </div>
